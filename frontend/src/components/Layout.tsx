  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      {manager && (
        <Link
          to="/manager/help"
          className={`fixed left-4 bottom-4 z-20 rounded-full px-4 py-2 text-sm font-semibold shadow-lg transition-all ${
            location.pathname === '/manager/help'
              ? 'bg-[#d89013] text-[#fff3db]'
              : 'bg-[#2f3438] text-[#d8e1ea] border border-[#4a545b] hover:bg-[#3a4248]'
          }`}
          title="Открыть подробную инструкцию"
        >
          Помощь
        </Link>
      )}
